...
public class FilmTypeController {
    ...
    @GetMapping("/{id}")
    public String getTypeByI1d(@PathVariable("id") String id){

        return filmTypeService.getTypeById(id);
    }
    @GetMapping("/{id}")
    public String getTypeById2(@PathVariable("id") String id){

        return filmTypeService.getTypeById(id);
    }

    @GetMapping("/{id}")
    public String getTypeById3(@PathVariable("id") String id){

        return filmTypeService.getTypeById(id);
    }
    @GetMapping("/{id}")
    public String getTypeById4(@PathVariable("id") String id){
